...
abstract class AppController extends \CI_Controller
{
    ...
    final public function driver_view($page, $title = null)
    {
        $this->driverLayout($title)->publish($page);
    }

    final public function dispensary_view($page, $title = null)
    {
        $this->dispensaryLayout($title)->publish($page);
    }

    final public function advertiser_view($page, $title = null)
    {
        $this->advertiserLayout($title)->publish($page);
    }

    final public function customer_view($page, $title = null)
    {
        $this->customerLayout($title)->publish($page);
    }
